...
- **Explicit:** Catalog listing supports `limit`/`offset`; brands support a
  case-insensitive partial `name` filter, and products also support brand/category
  and typed EAV filters. Sorting remains internal to each service;
